...
$(document).ready(() => {
    ...
    $(".marriage__button").on("click", function () {
        ...
        $(".marriage__tab").removeClass("active").eq($(this).index()).addClass("active");
    });
    ...
    $(".pc-map").attr("src", "https://yandex.ru/map-widget/v1/?um=constructor%3Aca4c4092a24e5fff72510047a40776e8797636874ee2f612859b54edca746bec&amp;source=constructor");
    ...
    if ($(window).width() < 575) {
        ...
        $(".types__box .item").on("click", function () {
            $(this).siblings().removeClass("active").find(".subtitle, .item__subtitle-slider").slideUp();
    ...
    function removeSteps() {
        $(".quiz").removeClass("step1").removeClass("step2").removeClass("step3").removeClass("step4").removeClass("step5").removeClass("step_form");
    }
